...
from drone_nav.geometry.local_coordinates import usable_pair_lat_lon
from drone_nav.telemetry.telemetry_schema import TelemetryRecord as TelemetryRecordModel
